...
class BaseContextService(BaseService):
    ...
    # Implement the abstract method from BaseService (required but not used)
    async def generate_content(self, primary_input: str, secondary_input: str) -> Tuple[str, Dict[str, Any]]:
        """Not used for context services - use execute_prompt instead."""
        raise NotImplementedError("Context services should use execute_prompt method")
